...
function timeline(argv, data, startX, startY, readYearCSV) {
	var mainWidth = argv.mainWidth || 900;
	var mainHeight = argv.mainHeight || 80;
	var cellWidth = 80;
	var cellHeight = 40;
	...
	//Create the canvas
	var canvasPtr = d3.select('#topButtonsBar').append('svg')
	...
	var centerLine = canvasPtr.append('line')
		.style('stroke', 'black')
	...
	var yearTicks = canvasPtr.selectAll('#yearTick')
		.data(data)
		.enter()
		.append('line')
		.style('stroke', 'black')
	...
	var yearOn = canvasPtr.selectAll('#yearOn')
		.data(data)
		.enter()
		.append('circle')
		.style('fill', '#F77')
	...
	var yearLabel = canvasPtr.selectAll('#yearLabel')
		.data(data)
		.enter()
		.append('text')
	...
	var yearMouseoverBox = canvasPtr.selectAll('#yearBox')
		.data(data)
		.enter()
		.append('rect')
		.style('fill', 'red')
